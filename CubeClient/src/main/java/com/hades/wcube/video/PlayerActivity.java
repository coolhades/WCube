...
import com.hades.wcube.service.BackGroundService;
...
public class PlayerActivity extends Activity implements UVPlayerCallBack, VideoController.PlayerControl
{
    ...
    private ServiceConnection controlConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            //绑定服务 启动service的轮询接口
            EtStartLoop startLoop = new EtStartLoop();
            startLoop.setFlag(1);
            EventBus.getDefault().post(startLoop);
        }
    ...
    public void changeControl(EtChangeControl changeControl){
        Log.d("PlayerActivity", "changeControl");
    }
...
//            mMediaplayer.setSource(UVMediaType.UVMEDIA_TYPE_M3U8, Path);
            mMediaplayer.setSource(UVMediaType.UVMEDIA_TYPE_MP4, "/data/user/0/com.hades.wcube/files/3A8EB81F4C2242078ADC19C54396CC99.mp4");
        }
        catch (Exception e)
        {
