package com.hades.wcube.cubecontrol.video;
...
import com.hades.wcube.cubecontrol.bean.event.EVPlayVideoBean;
...
//            "http://cache.utovr.com/201508270528174780.m3u8";
                             ...
                             @Nullable Bundle savedInstanceState)
    {
        ...
        initView(v);
        //初始化播放器
        rlPlayView = (RelativeLayout) v.findViewById(R.id.fragment_rlPlayView);
        mMediaplayer = new UVMediaPlayer(getActivity(), rlPlayView, mUVPlayerCallBack);

        //将工具条的显示或隐藏交个SDK管理，也可自己管理
        rlToolbar = (RelativeLayout) v.findViewById(R.id.fragment_rlToolbar);
    ...
    public void play(EVPlayVideoBean videoBean){
    ...
    private UVPlayerCallBack mUVPlayerCallBack = new UVPlayerCallBack(){
        ...
        public void createEnv()
        {
            try
            {
                ...
                if ("mp4".equalsIgnoreCase(Constant.type)) {
                    mMediaplayer.setSource(UVMediaType.UVMEDIA_TYPE_MP4, Constant.url);
                }else {
                    mMediaplayer.setSource(UVMediaType.UVMEDIA_TYPE_M3U8, Constant.url);
                }
...
//                mMediaplayer.setSource(UVMediaType.UVMEDIA_TYPE_MP4, Path);
    ...
    public void setDualScreenEnabled(boolean val)
    {
        ...
        Log.d("PlayerFragment", "callback= "+mMediaplayer.isDualScreenEnabled());
    }
